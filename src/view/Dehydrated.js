...
function Dehydrated() {
  return (
    <div>
      ...
      <h1 className="font-bold text-xl p-2">Recommend you drinking more water as following:</h1>
      <ul className="pl-3 pb-3">
        <li className="p-1">3 liters (about 13 cups) of fluid for a male adult each day</li>
        <li className="p-1">2.4 liters (about 10 cups) of fluid for a female adult each day</li>
        <li className="p-1">1.7 liters (about 7 cups) of fluid for a child each day</li>
      </ul>
